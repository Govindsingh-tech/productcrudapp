				...
				<input type="hidden" value="${product.id }" name="id">
					...
					<div class="form-group p-3">
						<label for="description"">Product Description</label> <textarea
							...
							name="description" rows="5" placeholder="Enter the product description">${product.description }</textarea>
							
					</div>
					<div class="form-group p-3">
						<label for="price"">Product price</label> <input
							type="text" class="form-control" id="price"
							name="price" rows="5" placeholder="Enter product price" value=${product.price }>
					</div>
